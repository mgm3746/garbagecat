...
public class Constants {
	...
	/**
	 * The threshold for the time (seconds) for the first log entry for a GC log to be considered
	 * complete. First log entries with timestamps below the threshold may indicate a partial GC log
	 * or GC events that were not a recognizable format.
	 */
	public static final int FIRST_TIMESTAMP_THRESHOLD = 60;

	/**
	 * The minimum throughput (percent of time spent not doing garbage collection for a given
	 * time interval) to not be flagged a bottleneck.
	 */
