 ...
 * 
 * <p>
 * Combine {@link org.eclipselabs.garbagecat.domain.jdk.ParallelSerialOldEvent} logging that is
 * split across 2 lines due to the garbage collection overhead limit being reached. This happens
 * when 98% of the total time is spent in garbage collection and less than 2% of the heap is
 * recovered. This feature is a throttle to prevent applications from running for an extended period
 * of time while making little or no progress because the heap is too small. If necessary, this
 ...
 * 
 * <p>
 * 1) GC time <em>would exceed</em> GCTimeLimit:
 * </p>
 * 
 * <pre>
 ...
 * 
 * <p>
 * 2) GC time <em>is exceeding</em> GCTimeLimit:
 * </p>
 * 
 * <pre>
