 ...
 * 
 * <p>
 * Young generation collector used when <code>-XX:+UseParallelGC</code> or
 * <code>-XX:+UseParallelOldGC</code> JVM options specified.
 * </p>
 * 
 ...
 * 
 * <p>
 * 2) With 2 dashes after the GC. This seems to happen when the JVM is stressed out doing continuous
 * full GCs:
 * </p>
 * 
 * <pre>
...
public class ParallelScavengeEvent implements BlockingEvent, YoungCollection, YoungData, OldData {
	 ...
	 */
	private static final String REGEX = "^" + JdkRegEx.TIMESTAMP + ": \\[GC(--)? \\[PSYoungGen: "
