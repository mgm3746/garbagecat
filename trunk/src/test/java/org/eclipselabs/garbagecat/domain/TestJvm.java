...
public class TestJvm extends TestCase {
	...
	public void testGetThreadStackShortSmallK() {
		...
		Jvm jvm = new Jvm(jvmOptions, null);
		Assert.assertEquals("Thread stack size not populated correctly.", "-Xss128k", jvm
				.getThreadStackSizeOption());
	}
	...
	public void testGetThreadStackShortSmallM() {
		...
		Jvm jvm = new Jvm(jvmOptions, null);
		Assert.assertEquals("Thread stack size not populated correctly.", "-Xss1m", jvm
				.getThreadStackSizeOption());
	}
	...
	public void testGetThreadStackLongSmallK() {
		...
		Jvm jvm = new Jvm(jvmOptions, null);
		Assert.assertEquals("Thread stack size incorrect.", "-XX:ThreadStackSize=128k", jvm
				.getThreadStackSizeOption());
	}
	...
	public void testGetThreadStackLongSmallM() {
		...
		Jvm jvm = new Jvm(jvmOptions, null);
		Assert.assertEquals("Thread stack size incorrect.", "-XX:ThreadStackSize=1m", jvm
				.getThreadStackSizeOption());
	}
	...
	public void testGetMinPermSmallM() {
		...
		Jvm jvm = new Jvm(jvmOptions, null);
		Assert.assertEquals("Min permanent generation option incorrect.", "-XX:PermSize=128m", jvm
				.getMinPermOption());
		Assert.assertEquals("Min permanent generation value incorrect.", "128m", jvm
				.getMinPermValue());
	}
	...
	public void testGetMinPermSmallG() {
		...
		Jvm jvm = new Jvm(jvmOptions, null);
		Assert.assertEquals("Min permanent generation option incorrect.", "-XX:PermSize=1g", jvm
				.getMinPermOption());
		Assert.assertEquals("Min permanent generation value incorrect.", "1g", jvm
				.getMinPermValue());
	}
	...
	public void testGetMaxPermSmallM() {
		...
		Assert.assertEquals("Max permanent generation value incorrect.", "128m", jvm
				.getMaxPermValue());
	}
	...
	public void testGetMaxPermSmallG() {
		String jvmOptions = "-Xss128k -Xms2048M -Xmx2048M -XX:PermSize=1g -XX:MaxPermSize=1g";
		Jvm jvm = new Jvm(jvmOptions, null);
		Assert.assertEquals("Max permanent generation option incorrect.", "-XX:MaxPermSize=1g", jvm
				.getMaxPermOption());
		Assert.assertEquals("Max permanent generation value incorrect.", "1g", jvm
				.getMaxPermValue());
	}
