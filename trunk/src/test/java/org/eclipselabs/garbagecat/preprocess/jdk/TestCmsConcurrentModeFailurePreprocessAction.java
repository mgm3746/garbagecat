...
public class TestCmsConcurrentModeFailurePreprocessAction extends TestCase {
	...
	public void testCmsSerialOldPrecleanLine() {
		String priorLogLine = "";
		String logLine = "77412.576: [Full GC 877412.576: [CMS877412.858: [CMS-concurrent-preclean: "
				+ "4.917/4.997 secs] [Times: user=6.45 sys=0.44, real=5.00 secs]";
		String nextLogLine = " (concurrent mode failure): 6010121K->6014591K(6014592K), 79.0505229 secs] "
	...
	public void testCmsSerialOldAbortedAbortablePrecleanLine() {
		...
		String logLine = "1361123.817: [Full GC (System) 1361123.818: [CMS CMS: abort preclean due to time "
				+ "1361123.838: [CMS-concurrent-abortable-preclean: 5.030/5.089 secs] "
	...
	public void testCmsSerialOldMarkLine() {
		String priorLogLine = "";
		String logLine = "85238.030: [Full GC 85238.030: [CMS85238.672: [CMS-concurrent-mark: "
				+ "0.666/0.686 secs] [Times: user=1.40 sys=0.01, real=0.69 secs]";
		String nextLogLine = " (concurrent mode failure): 6010121K->6014591K(6014592K), 79.0505229 secs] "
				+ "6217865K->6028029K(6256896K), [CMS Perm : 206688K->206662K(262144K)], 79.0509595 secs] "
				+ "[Times: user=104.69 sys=3.63, real=79.05 secs]";
		Assert.assertTrue("Log line not recognized as "
	...
	public void testCmsSerialOldSweepLine() {
		String priorLogLine = "";
		String logLine = "827123.748: [Full GC (System) 827123.748: [CMS827125.337: "
				+ "[CMS-concurrent-sweep: 2.819/2.862 secs] [Times: user=3.11 sys=0.13, real=2.86 secs]";
		String nextLogLine = " (concurrent mode failure): 6010121K->6014591K(6014592K), 79.0505229 secs] "
				+ "6217865K->6028029K(6256896K), [CMS Perm : 206688K->206662K(262144K)], 79.0509595 secs] "
				+ "[Times: user=104.69 sys=3.63, real=79.05 secs]";
		Assert.assertTrue("Log line not recognized as "
	...
	public void testCmsSerialOldBailingOutLine() {
		...
		String nextLogLine = "4310.434: [CMS-concurrent-mark: 10.548/10.777 secs] "
				+ "[Times: user=40.43 sys=3.94, real=10.78 secs]";
		Assert.assertTrue("Log line not recognized as "
				+ JdkUtil.PreprocessActionType.CMS_CONCURRENT_MODE_FAILURE.toString() + ".",
				CmsConcurrentModeFailurePreprocessAction.match(logLine, priorLogLine, nextLogLine));
	}
	...
	public void testParNewPromotionFailedAbortedAbortablePrecleanLine() {
		String priorLogLine = "";
		String logLine = "1319504.530: [GC 1319504.531: [ParNew: 786379K->786379K(917504K), "
				+ "0.0000350 secs]1319504.531: [CMS CMS: abort preclean due to time 1319504.546: "
				+ "[CMS-concurrent-abortable-preclean: 0.682/5.152 secs] "
				+ "[Times: user=1.47 sys=0.31, real=5.15 secs]";
		String nextLogLine = " (concurrent mode failure): 6010121K->6014591K(6014592K), 79.0505229 secs] "
				+ "6217865K->6028029K(6256896K), [CMS Perm : 206688K->206662K(262144K)], 79.0509595 secs] "
				+ "[Times: user=104.69 sys=3.63, real=79.05 secs]";
		Assert.assertTrue("Log line not recognized as "
	...
	public void testParNewSweepLine() {
		String priorLogLine = "";
		String logLine = "5300.084: [GC 5300.084: [ParNew: 58640K->196K(242304K), 0.0278816 secs]"
				+ "5300.112: [CMS5302.628: [CMS-concurrent-sweep: 7.250/7.666 secs] "
	...
	public void testConcurrentModeFailurePrecleanLine() {
		String priorLogLine = "877412.576: [Full GC 877412.576: [CMS877412.858: [CMS-concurrent-preclean: "
				+ "4.917/4.997 secs] [Times: user=6.45 sys=0.44, real=5.00 secs]";
		String logLine = " (concurrent mode failure): 1572863K->1547074K(1572864K), 10.7226790 secs] "
				+ "2490334K->1547074K(2490368K), [CMS Perm : 46357K->46354K(77352K)], 10.7239680 secs] "
	...
	public void testConcurrentModeFailureAbortablePrecleanLine() {
		String priorLogLine = "85217.903: [Full GC 85217.903: [CMS85217.919: [CMS-concurrent-abortable-preclean: "
				+ "0.723/3.756 secs] [Times: user=2.54 sys=0.08, real=3.76 secs]";
		String logLine = " (concurrent mode failure): 439328K->439609K(4023936K), 2.7153820 secs] "
				+ "448884K->439609K(4177280K), [CMS Perm : 262143K->262143K(262144K)], 2.7156150 secs] "
	...
	public void testConcurrentModeFailureMarkLine() {
		String priorLogLine = "3070.289: [GC 3070.289: [ParNew: 207744K->207744K(242304K), 0.0000682 secs]"
				+ "3070.289: [CMS3081.621: [CMS-concurrent-mark: 11.907/12.958 secs] "
				+ "[Times: user=45.31 sys=3.93, real=12.96 secs]";
		String logLine = " (concurrent mode failure): 6010121K->6014591K(6014592K), 79.0505229 secs] "
				+ "6217865K->6028029K(6256896K), [CMS Perm : 206688K->206662K(262144K)], 79.0509595 secs] "
				+ "[Times: user=104.69 sys=3.63, real=79.05 secs]";
		String nextLogLine = "";
		Assert.assertTrue("Log line not recognized as "
	...
	public void testConcurrentModeInterruptedSweepLine() {
		String priorLogLine = "827123.748: [Full GC (System) 827123.748: [CMS827125.337: "
				+ "[CMS-concurrent-sweep: 2.819/2.862 secs] [Times: user=3.11 sys=0.13, real=2.86 secs]";
		String logLine = " (concurrent mode interrupted): 1177627K->890349K(1572864K), 7.1730360 secs] "
				+ "2048750K->890349K(2490368K), [CMS Perm : 46357K->46352K(77352K)], 7.1743670 secs] "
