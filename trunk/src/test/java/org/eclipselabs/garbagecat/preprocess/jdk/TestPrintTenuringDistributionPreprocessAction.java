...
public class TestPrintTenuringDistributionPreprocessAction extends TestCase {
    ...
    public void testDefNewLine() {
        ...
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.PRINT_TENURING_DISTRIBUTION.toString() + ".", PrintTenuringDistributionPreprocessAction.match(logLine));
    }
