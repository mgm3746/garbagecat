...
public class TestThreadDumpPreprocessAction extends TestCase {
    ...
    public void testBeginningDateTime() {
        ...
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".", ThreadDumpPreprocessAction.match(logLine));
    }
    ...
    public void testThreadDataRunnable4SpaceNid() {
        String logLine = "\"Thread-144233478\" daemon prio=10 tid=0x22817800 nid=0x77f5 " + "runnable [0x25174000..0x25175030]";
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".", ThreadDumpPreprocessAction.match(logLine));
    }

    public void testThreadDataWaiting4SpaceNid() {
        String logLine = "\"ajp-127.0.0.1-8009-2038\" daemon prio=10 tid=0x3eebb000 nid=0x1d16 " + "in Object.wait() [0x252be000..0x252befb0]";
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".", ThreadDumpPreprocessAction.match(logLine));
    }

    public void testThreadDataBlocked3SpaceNid() {
        String logLine = "\"ajp-127.0.0.1-8009-65\" daemon prio=10 tid=0x3ee5f800 nid=0x702 " + "waiting for monitor entry [0x3ce62000..0x3ce630b0]";
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".", ThreadDumpPreprocessAction.match(logLine));
    }

    public void testThreadDataBlocked4SpaceNid() {
        String logLine = "\"ajp-127.0.0.1-8009-2032\" daemon prio=10 tid=0x3df37000 nid=0x1d0f " + "waiting for monitor entry [0x25363000..0x25363eb0]";
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".", ThreadDumpPreprocessAction.match(logLine));
    }

    public void testThreadDataNonDaemon() {
        String logLine = "\"JBossLifeThread\" prio=10 tid=0x08f4f400 nid=0x7996 in Object.wait() " + "[0x3e992000..0x3e993030]";
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".", ThreadDumpPreprocessAction.match(logLine));
    }

    public void testThreadDataNameWithSpaces() {
        String logLine = "\"Cache Object Manager Monitor\" prio=10 tid=0x095aa000 nid=0x7992 in Object.wait() " + "[0x3e315000..0x3e315e30]";
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".", ThreadDumpPreprocessAction.match(logLine));
    }

    public void testThreadDataNameWithBrackets() {
        String logLine = "\"ContainerBackgroundProcessor[StandardEngine[jboss.web]]\" daemon prio=10 " + "tid=0x088a2000 nid=0x797a waiting on condition [0x3ea9f000..0x3ea9fe30]";
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".", ThreadDumpPreprocessAction.match(logLine));
    }
    ...
    public void testThreadDataNameNoSpaceBeforeAddressRange() {
        String logLine = "\"ContainerBackgroundProcessor[StandardEngine[jboss.web]]\" daemon prio=10 " + "tid=0x088a2000 nid=0x797a sleeping[0x3ea9f000..0x3ea9fe30]";
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".", ThreadDumpPreprocessAction.match(logLine));
    }
    ...
    public void testThreadData16Bytes() {
        String logLine = "\"LDAPConnThread 10.235.5.15:1502\" daemon prio=1 tid=0x0000002bace3e260 " + "nid=0x2de1 runnable [0x00000000582d0000..0x00000000582d0e30]";
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".", ThreadDumpPreprocessAction.match(logLine));
    }
