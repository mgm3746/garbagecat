 ...
 * 
 */
public class UnifiedFooterStatsEvent implements ThrowAwayEvent {
    ...
    private static final String REGEX[] = {
            ...
            "^" + UnifiedRegEx.DECORATOR
                    ...
                    + "Code Cache Cleaning |Code Cache Roots|FlatProfiler Roots|JFR Weak Roots|JNI Handles Roots|JNI Roots|"
            ...
            // 2-3 spaces
            "^" + UnifiedRegEx.DECORATOR
                    + "   (Choose Collection Set|Evacuation|Finish Mark|Finish Queues|Initial Evacuation|Manage GCLABs|Manage GC\\/TLABs|"
                    + "Prepare|Prepare Evacuation|Purge Unlinked|Rebuild Free Set|Recycle|Rendezvous|Roots|System Purge|Trash Collection Set|"
