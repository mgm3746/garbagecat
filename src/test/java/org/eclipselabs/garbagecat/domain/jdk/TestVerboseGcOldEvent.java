...
class TestVerboseGcOldEvent {
    ...
    void testLogLine() {
        ...
        assertEquals(kilobytes(1409859), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(2976064), event.getCombinedSpace(), "Combined space size not parsed correctly.");
    ...
    void testLogLineDatestampTimestamp() {
        ...
        assertEquals(kilobytes(500269), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(500224), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
    ...
    void testLogLineG1Sizes() {
        ...
        assertEquals(kilobytes(8329216), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(2405376), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(8388608), event.getCombinedSpace(), "Combined space size not parsed correctly.");
    ...
    void testLogLineTriggerAllocationFailure() {
        ...
        assertEquals(kilobytes(7455264), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(4498878), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(7992832), event.getCombinedSpace(), "Combined space size not parsed correctly.");
    ...
    void testLogLineTriggerErgonomics() {
        ...
        assertEquals(kilobytes(728595), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(382365), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(932352), event.getCombinedSpace(), "Combined space size not parsed correctly.");
    ...
    void testLogLineTriggerExplicitGc() {
        ...
        assertEquals(kilobytes(457601), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(176797), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
    ...
    void testLogLineTriggerLastDitchCollection() {
        ...
        assertEquals(kilobytes(457103), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(449140), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(3128704), event.getCombinedSpace(), "Combined space size not parsed correctly.");
    ...
    void testLogLineTriggerMetadataGcThreshold() {
        ...
        assertEquals(kilobytes(629455), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(457103), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(3128704), event.getCombinedSpace(), "Combined space size not parsed correctly.");
