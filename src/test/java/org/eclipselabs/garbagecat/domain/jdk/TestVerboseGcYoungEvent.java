...
class TestVerboseGcYoungEvent {
    ...
    void testIsBlocking() {
        ...
        assertTrue(JdkUtil.isBlocking(JdkUtil.identifyEventType(logLine, null, CollectorFamily.UNKNOWN)),
                JdkUtil.EventType.VERBOSE_GC_YOUNG.toString() + " not indentified as blocking.");
    }
    ...
    void testLogLine() {
        ...
        assertTrue(VerboseGcYoungEvent.match(logLine),
                "Log line not recognized as " + JdkUtil.EventType.VERBOSE_GC_YOUNG.toString() + ".");
        VerboseGcYoungEvent event = new VerboseGcYoungEvent(logLine);
        assertEquals(JdkUtil.EventType.VERBOSE_GC_YOUNG, event.getEventType(), "Event type incorrect.");
        assertEquals(2205570508L, event.getTimestamp(), "Time stamp not parsed correctly.");
        assertEquals(kilobytes(1726387), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(773247), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(3097984), event.getCombinedSpace(), "Combined space size not parsed correctly.");
        assertEquals(231803, event.getDurationMicros(), "Duration not parsed correctly.");
    }
    ...
    void testLogLineDatestampTimestamp() {
        ...
        assertEquals(kilobytes(136320), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(18558), event.getCombinedOccupancyEnd(), "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(3128704), event.getCombinedSpace(), "Combined space size not parsed correctly.");
        assertEquals(102816, event.getDurationMicros(), "Duration not parsed correctly.");
    }
    ...
    void testLogLineMissingBeginningOccupancy() {
        ...
        assertEquals(kilobytes(876593), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(876593), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(1851392), event.getCombinedSpace(), "Combined space size not parsed correctly.");
        assertEquals(70178, event.getDurationMicros(), "Duration not parsed correctly.");
    }
    ...
    void testLogLineTriggerCmsFinalRemark() {
        ...
        // We set beginging to end occupancy
        assertEquals(kilobytes(521627), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(521627), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(3128704), event.getCombinedSpace(), "Combined space size not parsed correctly.");
        assertEquals(248127, event.getDurationMicros(), "Duration not parsed correctly.");
    }
    ...
    void testLogLineTriggerCmsInitialMark() {
        ...
        // We set beginging to end occupancy
        assertEquals(kilobytes(59894), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(59894), event.getCombinedOccupancyEnd(), "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(3128704), event.getCombinedSpace(), "Combined space size not parsed correctly.");
        assertEquals(5884, event.getDurationMicros(), "Duration not parsed correctly.");
    }
    ...
    void testLogLineTriggerExplicitGc() {
        ...
        assertEquals(kilobytes(525225), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(457601), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(939520), event.getCombinedSpace(), "Combined space size not parsed correctly.");
        assertEquals(32544, event.getDurationMicros(), "Duration not parsed correctly.");
    }
    ...
    void testLogLineTriggerGcLockerInitiatedGc() {
        ...
        assertEquals(kilobytes(128035), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(124539), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(3128704), event.getCombinedSpace(), "Combined space size not parsed correctly.");
        assertEquals(71349, event.getDurationMicros(), "Duration not parsed correctly.");
    }
    ...
    void testLogLineTriggerMetadataGcThreshold() {
        ...
        assertEquals(kilobytes(288163), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(251266), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(1253376), event.getCombinedSpace(), "Combined space size not parsed correctly.");
        assertEquals(18304, event.getDurationMicros(), "Duration not parsed correctly.");
    }
    ...
    void testLogLineTriggerWithDashes() {
        ...
        assertEquals(kilobytes(1044870), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(1045980), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(1046016), event.getCombinedSpace(), "Combined space size not parsed correctly.");
        assertEquals(106125, event.getDurationMicros(), "Duration not parsed correctly.");
    }
    ...
    void testLogLineWithDashes() {
        ...
        assertEquals(kilobytes(5524217), event.getCombinedOccupancyInit(),
                "Combined initial occupancy not parsed correctly.");
        assertEquals(kilobytes(5911480), event.getCombinedOccupancyEnd(),
                "Combined end occupancy not parsed correctly.");
        assertEquals(kilobytes(5911488), event.getCombinedSpace(), "Combined space size not parsed correctly.");
        assertEquals(1556436, event.getDurationMicros(), "Duration not parsed correctly.");
    }
}
