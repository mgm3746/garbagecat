...
public class TestParNewConcurrentModeFailurePermDataEvent extends TestCase {
    ...
    public void testSweepLogLine() {
        ...
        Assert.assertEquals("Young begin size not parsed correctly.", (2332760 - 2274119),
                event.getYoungOccupancyInit());
    ...
    public void testAbortablePrecleanLogLine() {
        ...
        Assert.assertEquals("Young begin size not parsed correctly.", (2333467 - 1547074),
                event.getYoungOccupancyInit());
    ...
    public void testAbortedAbortablePrecleanLogLine() {
        ...
        Assert.assertEquals("Young begin size not parsed correctly.", (2358773 - 1572393),
                event.getYoungOccupancyInit());
    ...
    public void testPrecleanLogLine() {
        ...
        Assert.assertEquals("Young begin size not parsed correctly.", (12442101 - 12199797),
                event.getYoungOccupancyInit());
        Assert.assertEquals("Young end size not parsed correctly.", (11189714 - 11189714),
    ...
    public void testIncrementalModeLine() {
        ...
        Assert.assertEquals("Young begin size not parsed correctly.", (11998424 - 9991384),
                event.getYoungOccupancyInit());
