 ...
 * 
 */
public class TestPrintHeapAtGcEvent extends TestCase {

    public void testHeapBeforeLowerCaseGcLine() {
        String logLine = "{Heap before gc invocations=1:";
        Assert.assertTrue("Log line not recognized as " + JdkUtil.LogEventType.PRINT_HEAP_AT_GC.toString() + ".",
                PrintHeatAtGcEvent.match(logLine));
    }
