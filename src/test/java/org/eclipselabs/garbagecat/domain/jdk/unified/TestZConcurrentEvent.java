...
class TestZConcurrentEvent {
    ...
    void testMetaspaceIdentityEventType() {
        String logLine = "[2024-11-19T04:02:29.854+0800][1508.444s][info ][gc,metaspace            ] GC(131) O: "
                + "Metaspace: 55M used, 58M committed, 1088M reserved";
        assertEquals(JdkUtil.LogEventType.Z_CONCURRENT,
                JdkUtil.identifyEventType(logLine, null, CollectorFamily.UNKNOWN),
                JdkUtil.LogEventType.Z_CONCURRENT + "not identified.");
    }
    ...
    @Test
    void testReportable() {
        assertTrue(JdkUtil.isReportable(JdkUtil.LogEventType.Z_CONCURRENT),
                JdkUtil.LogEventType.Z_CONCURRENT.toString() + " not indentified as reportable.");
    }
