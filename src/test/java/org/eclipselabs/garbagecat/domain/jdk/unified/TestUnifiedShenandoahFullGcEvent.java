...
import static org.eclipselabs.garbagecat.util.jdk.JdkUtil.LogEventType.UNIFIED_SHENANDOAH_FULL_GC;
...
class TestUnifiedShenandoahFullGcEvent {
    ...
    @Test
    void testHydration() {
        LogEventType eventType = UNIFIED_SHENANDOAH_FULL_GC;
        String logLine = "[10.478s][info][gc] GC(0) Pause Full 1589M->1002M(1690M), 4077.274 ms";
        long timestamp = 478;
        int duration = 4077;
    ...
    @Test
    void testReportable() {
        assertTrue(JdkUtil.isReportable(UNIFIED_SHENANDOAH_FULL_GC),
                UNIFIED_SHENANDOAH_FULL_GC + " not indentified as reportable.");
    }
