...
public class TestParNewConcurrentModeFailureEvent extends TestCase {
    ...
    public void testAbortablePrecleanLogLine() {
        ...
        Assert.assertEquals("Young begin size not parsed correctly.", (1409660 - 1147900),
                event.getYoungOccupancyInit());
    ...
    public void testPrecleanIncrementalModeLogLine() {
        ...
        Assert.assertEquals("Young begin size not parsed correctly.", (2058661 - 1796901),
                event.getYoungOccupancyInit());
    ...
    public void testSweepIncrementalModeLogLine() {
        ...
        Assert.assertEquals("Young begin size not parsed correctly.", (2070023 - 1808263),
                event.getYoungOccupancyInit());
    ...
    public void testMarkLogLine() {
        ...
        Assert.assertEquals("Young begin size not parsed correctly.", (1412753 - 1150993),
                event.getYoungOccupancyInit());
