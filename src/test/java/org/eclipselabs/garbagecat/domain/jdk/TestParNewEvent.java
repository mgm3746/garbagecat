...
public class TestParNewEvent {
    ...
    public void testLogLine() {
        ...
        assertEquals("Young begin size not parsed correctly.", 86199, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 8454, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 91712, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", 3200, event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", 3201, event.getOldOccupancyEnd());
    ...
    public void testLogLineWithTimesData() {
        ...
        assertEquals("Young begin size not parsed correctly.", 149120, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 18211, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 149120, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", 3908656, event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", 3913030, event.getOldOccupancyEnd());
    ...
    public void testLogLineWithIcmsDcData() {
        ...
        assertEquals("Young begin size not parsed correctly.", 54564, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 1006, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 59008, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (417639 - 54564), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (364081 - 1006), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (1828480 - 59008), event.getOldSpace());
    ...
    public void testLogLineJdk8WithTrigger() {
        ...
        assertEquals("Young begin size not parsed correctly.", 886080, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 11485, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 996800, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (886080 - 886080), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (11485 - 11485), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (1986432 - 996800), event.getOldSpace());
    ...
    public void testLogLineJdk8NoSpaceAfterTrigger() {
        ...
        assertTrue("Trigger not parsed correctly.",
                event.getTrigger().matches(JdkRegEx.TRIGGER_ALLOCATION_FAILURE));
        assertEquals("Young begin size not parsed correctly.", 136576, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 17023, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 153600, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (136576 - 136576), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (19515 - 17023), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (494976 - 153600), event.getOldSpace());
    ...
    public void testLogLineGcLockerTrigger() {
        ...
        assertEquals("Young begin size not parsed correctly.", 1228800, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 30695, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 1382400, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (1228800 - 1228800), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (30695 - 30695), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (8235008 - 1382400), event.getOldSpace());
    ...
    public void testLogLineCmsScavengeBeforeRemark() {
        ...
        assertEquals("Young begin size not parsed correctly.", 1388745, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 458752, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 4128768, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (2977822 - 1388745), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (2161212 - 458752), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (13172736 - 4128768), event.getOldSpace());
    ...
    public void testLogLineSystemGcTrigger() {
        ...
        assertEquals("Young begin size not parsed correctly.", 925502, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 58125, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 996800, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (5606646 - 925502), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (4742781 - 58125), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (8277888 - 996800), event.getOldSpace());
    ...
    public void testLogLinePromotionFailed() {
        ...
        assertEquals("Young begin size not parsed correctly.", 476295, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 476295, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 4128768, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (7385012 - 476295), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (7555732 - 476295), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (13172736 - 4128768), event.getOldSpace());
    ...
    public void testLogLineWithDatestamp() {
        ...
        assertEquals("Young begin size not parsed correctly.", 273152, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 858, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 341376, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (273152 - 273152), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (858 - 858), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (980352 - 341376), event.getOldSpace());
    ...
    public void testLogLineWithDoubleDatestamp() {
        ...
        assertEquals("Young begin size not parsed correctly.", 272640, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 33532, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 306688, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (272640 - 272640), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (33532 - 33532), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (1014528 - 306688), event.getOldSpace());
    ...
    public void testLogLineTriggerCmsFinalRemarkJdk8() {
        ...
        assertEquals("Young begin size not parsed correctly.", 100369, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 10116, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 153344, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (100369 - 100369), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (16685 - 10116), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (4177280 - 153344), event.getOldSpace());
    ...
    public void testLogLineTriggerCmsFinalRemarkJdk8WithTimeStamps() {
        ...
        assertTrue("Trigger not parsed correctly.",
                event.getTrigger().matches(JdkRegEx.TRIGGER_CMS_FINAL_REMARK));
        assertEquals("Young begin size not parsed correctly.", 4266790, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 922990, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 8388608, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (6417140 - 4266790), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (3472610 - 922990), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (22020096 - 8388608), event.getOldSpace());
    ...
    public void testLogLineNoSpaceAfterTrigger() {
        ...
        assertTrue("Trigger not parsed correctly.",
                event.getTrigger().matches(JdkRegEx.TRIGGER_CMS_FINAL_REMARK));
        assertEquals("Young begin size not parsed correctly.", 2619547, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 569438, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 8388608, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (6555444 - 2619547), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (5043068 - 569438), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (22020096 - 8388608), event.getOldSpace());
    ...
    public void testLogLineTriggerPromotionFailed() {
        ...
        assertEquals("Young begin size not parsed correctly.", 5117539, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 5001473, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 8388608, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (17958061 - 5117539), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (18622281 - 5001473), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (22020096 - 8388608), event.getOldSpace());
    ...
    public void testLogLineTriggerScavengeBeforeRemarkNoGcDetailsPreprocessed() {
        ...
        assertTrue("Trigger not parsed correctly.",
                event.getTrigger().matches(JdkRegEx.TRIGGER_CMS_FINAL_REMARK));
        assertEquals("Young begin size not parsed correctly.", 890910, event.getYoungOccupancyInit());
        assertEquals("Young end size not parsed correctly.", 620060, event.getYoungOccupancyEnd());
        assertEquals("Young available size not parsed correctly.", 7992832, event.getYoungSpace());
        assertEquals("Old begin size not parsed correctly.", (620060 - 620060), event.getOldOccupancyInit());
        assertEquals("Old end size not parsed correctly.", (620060 - 620060), event.getOldOccupancyEnd());
        assertEquals("Old allocation size not parsed correctly.", (7992832 - 7992832), event.getOldSpace());
