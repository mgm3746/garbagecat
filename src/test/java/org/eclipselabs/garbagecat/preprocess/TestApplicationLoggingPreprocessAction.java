...
public class TestApplicationLoggingPreprocessAction extends TestCase {
    ...
    public void testHhMmSsError() {
        ...
        Assert.assertTrue(
                "Log line not recognized as " + JdkUtil.PreprocessActionType.APPLICATION_LOGGING.toString() + ".",
    ...
    public void testStackTrace() {
        ...
        Assert.assertTrue("Log line not recognized as " + JdkUtil.PreprocessActionType.THREAD_DUMP.toString() + ".",
                ApplicationLoggingPreprocessAction.match(logLine));
    }
