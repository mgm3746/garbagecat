...
public class UnifiedRegEx {
     ...
     * [gc,heap ]
     */
    public static final String TAGS = "(\\[((age|alloc|arguments|cds|cleanup|coops|cpu|cset|ergo|exit|free|gc|heap|"
            + "humongous|ihop|init|jni|load|marking|metaspace|mmu|nmethod|numa|phases|plab|ref|reloc|ref|refine|"
            + "region|remset|safepoint|stats|start|stringtable|stringdedup|tracking|task|thread|time|tlab)"
            + "[,]{0,1}){1,}[ ]{0,}\\])";
