 ...
 * 
 */
public class ZMarkStartEvent extends ZCollector implements UnifiedLogging, BlockingEvent {

    private static final Pattern PATTERN = Pattern.compile(ZMarkStartEvent.REGEX);

    /**
     * Regular expressions defining the logging.
     */
    private static final String REGEX = "^" + UnifiedRegEx.DECORATOR + " Pause Mark Start " + UnifiedRegEx.DURATION
            + "[ ]*$";
     ...
     */
    public ZMarkStartEvent(String logEntry) {
     ...
     */
    public ZMarkStartEvent(String logEntry, long timestamp, int duration) {
        this.logEntry = logEntry;
    ...
    public String getName() {
        return JdkUtil.LogEventType.Z_MARK_START.toString();
    }
