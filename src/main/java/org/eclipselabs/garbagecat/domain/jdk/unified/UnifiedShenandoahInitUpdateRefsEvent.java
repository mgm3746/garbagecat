...
/**
 * <p>
 * UNIFIED_SHENANDOAH_INIT_UPDATE_REFS
 * </p>
 * 
 * <p>
...
public class UnifiedShenandoahInitUpdateRefsEvent extends ShenandoahCollector
     ...
     */
    public UnifiedShenandoahInitUpdateRefsEvent(String logEntry) {
     ...
     */
    public UnifiedShenandoahInitUpdateRefsEvent(String logEntry, long timestamp, int duration) {
        this.logEntry = logEntry;
    ...
    public String getName() {
        return JdkUtil.LogEventType.UNIFIED_SHENANDOAH_INIT_UPDATE_REFS.toString();
    }
