...
public class FooterStatsEvent implements ThrowAwayEvent {
    ...
    private static final String REGEX[] = {
            //
            "^(" + UnifiedRegEx.DECORATOR + " )?(GC STATISTICS:|={3} Garbage Collection Statistics ={119})$",
            //
            ...
            //
            "^" + UnifiedRegEx.DECORATOR
                    + "[ ]+(Contention|Critical|Major Collection|Memory|Minor Collection|Old Generation|Old Pause|"
                    + "Old Phase|Old Subphase|System|Young Generation|Young Pause|Young Phase|Young Subphase): .+$",
            //
