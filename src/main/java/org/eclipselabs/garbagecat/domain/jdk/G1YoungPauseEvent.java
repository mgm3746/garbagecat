    ...
    public G1YoungPauseEvent(String logEntry) {
        ...
        if (logEntry.matches(REGEX)) {
            ...
            if (matcher.find()) {
                ...
                combined = Memory.memory(matcher.group(5), matcher.group(7).charAt(0)).convertTo(KILOBYTES);
                combinedEnd = Memory.memory(matcher.group(8), matcher.group(10).charAt(0)).convertTo(KILOBYTES);
                combinedAvailable = Memory.memory(matcher.group(11), matcher.group(13).charAt(0)).convertTo(KILOBYTES);
