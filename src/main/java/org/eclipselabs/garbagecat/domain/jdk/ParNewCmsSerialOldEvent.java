 ...
 * {@link org.eclipselabs.garbagecat.domain.jdk.CmsSerialOldEvent}. It looks like this happens when
...
public class ParNewCmsSerialOldEvent implements BlockingEvent, OldCollection, YoungData, OldData {
	...
	public ParNewCmsSerialOldEvent(String logEntry) {
		...
		Pattern pattern = Pattern.compile(ParNewCmsSerialOldEvent.REGEX);
