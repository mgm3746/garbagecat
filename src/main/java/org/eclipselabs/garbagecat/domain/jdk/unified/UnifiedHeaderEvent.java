...
public class UnifiedHeaderEvent extends G1Collector implements UnifiedLogging {
    ...
    private static final String REGEX = "^" + UnifiedRegEx.DECORATOR
            + " ((CDS archive\\(s\\)|Compressed class space) mapped at|Compressed Oops|CPUs|"
            + "Heap (Initial|Max|Min) Capacity|Large Page Support|Memory|Narrow klass base|NUMA Support|Pre-touch|"
            + "Version):.+$";
