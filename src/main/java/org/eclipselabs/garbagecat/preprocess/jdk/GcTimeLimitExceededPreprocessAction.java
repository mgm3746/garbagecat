 ...
 * {@link org.eclipselabs.garbagecat.domain.jdk.ParallelOldCompactingEvent} logging that is split
 * across 2 lines due to the garbage collection overhead limit being reached. This happens when 98%
 * of the total time is spent in garbage collection and less than 2% of the heap is recovered. This
 * feature is a throttle to prevent applications from running for an extended period of time while
 * making little or no progress because the heap is too small. If necessary, this feature can be
 * disabled with the <code>-XX:-UseGCOverheadLimit</code> option.
 * </p>
 * 
 * <h3>Example Logging</h3>
 * 
 * <p>
 * 1) {@link org.eclipselabs.garbagecat.domain.jdk.ParallelSerialOldEvent} with "GC time
 * <em>would exceed</em> GCTimeLimit":
 * </p>
 * 
 * <pre>
 ...
 * 
 * <p>
 * 2) {@link org.eclipselabs.garbagecat.domain.jdk.ParallelSerialOldEvent} with "GC time
 * <em>is exceeding</em> GCTimeLimit":
 * </p>
 * 
 * <pre>
 ...
 * 
 * <p>
 * 3) {@link org.eclipselabs.garbagecat.domain.jdk.ParallelOldCompactingEvent} with "GC time
 * <em>is exceeding</em> GCTimeLimit":
 * </p>
 * 
 * <pre>
...
public class GcTimeLimitExceededPreprocessAction implements PreprocessAction {
	...
	private static final String REGEX_LINE1 = "^(" + JdkRegEx.TIMESTAMP
			+ ": \\[Full GC \\[PSYoungGen: " + JdkRegEx.SIZE + "->" + JdkRegEx.SIZE + "\\("
			+ JdkRegEx.SIZE + "\\)\\] \\[(PS|Par)OldGen: " + JdkRegEx.SIZE + "->" + JdkRegEx.SIZE
			+ "\\(" + JdkRegEx.SIZE + "\\)\\] " + JdkRegEx.SIZE + "->" + JdkRegEx.SIZE + "\\("
			+ JdkRegEx.SIZE + "\\) \\[PSPermGen: " + JdkRegEx.SIZE + "->" + JdkRegEx.SIZE + "\\("
			+ JdkRegEx.SIZE
	 ...
	 */
	private static final String REGEX_LINE2 = "^, " + JdkRegEx.DURATION + "\\]"
